...
class EditCoverImage extends BaseComponent<
  EditCoverImageProps,
  EditCoverImageState
> {
...
export class CommunityCover extends Component<Props> {
  ...
  render() {
    ...
    const subscribers = formattedNumber(community.subscribers, {
      fractionDigits: 0,
    });
    const rewards = formattedNumber(community.sum_pending, {
      fractionDigits: 0,
    });
    const authors = formattedNumber(community.num_authors, {
      fractionDigits: 0,
    });

    const canUpdateCoverImage =
