...
export interface KeyChainImpl {
    ...
    requestSignBuffer(account: string, message: string, key: AuthorityTypes, callback: (r: TxResponse) => void, rpc: string | null): void;

    requestAddAccountAuthority(account: string, authorizedUsername: string, role: AuthorityTypes, weight: number, callback: (r: TxResponse) => void, rpc: string | null): void;

    requestRemoveAccountAuthority(account: string, authorizedUsername: string, role: AuthorityTypes, callback: (r: TxResponse) => void, rpc: string | null): void;

    requestTransfer(account: string, to: string, amount: string, memo: string, currency: Symbol, callback: (r: TxResponse) => void, enforce: boolean, rpc: string | null): void;

    requestCustomJson(account: string, id: string, key: AuthorityTypes, json: string, display_msg: string, callback: (r: TxResponse) => void, rpc: string | null): void;
